# Generated by Django 6.0.1 on 2026-04-13 16:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_at', models.DateTimeField(default=accounts.models.default_expires_at)),
            ],
        ),
        migrations.CreateModel(
            name='Platform',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vk_link', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.AddField(
            model_name='group',
            name='platform',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.platform'),
        ),
        migrations.CreateModel(
            name='ServiceAccount',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=128)),
                ('groups', models.ManyToManyField(related_name='groups', to='accounts.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='data', to='accounts.serviceaccount')),
            ],
        ),
        migrations.CreateModel(
            name='TelegramToken',
